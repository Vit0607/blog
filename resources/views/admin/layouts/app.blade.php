...
<head>
    ...
    /* Убрал пробел после hover: и focus: */
    .btn-outline {
        @apply border border-white/15 text-gray-200 hover:border-white/30;
    }

    .input {
        @apply w-full rounded-xl bg-white/5 border border-white/15 px-3 py-2 text-sm outline-none focus:border-white/30 placeholder:text-gray-400;
    }

    .badge {
        @apply inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs border border-white/15 text-gray-300;
    }
</style>
