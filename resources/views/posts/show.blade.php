...
<main class="mx-auto max-w-6xl px-4 py-10">
    <div class="flex flex-col gap-4 bg-gray-900/40 p-6 rounded-2xl">
        <div>
            <a href="{{ route('blog.index') }}" class="inline-flex items-center gap-2 rounded-xl border border-white/10 px-3 py-2 text-sm text-gray-300 transition hover:text-white">
                &larr; Ко всем постам
            </a>
        </div>
